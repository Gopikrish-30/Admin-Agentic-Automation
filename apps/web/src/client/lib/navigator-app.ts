/**
 * Admin API - Interface to the Electron main process
 *
...
declare global {
  interface Window {
    navigatorApp?: AdminAppAPI;
    navigatorAppShell?: AdminAppShell;
  }
}
...
export function getAdminApp() {
  if (!window.navigatorApp) {
    throw new Error('Admin API not available - not running in Electron');
  }
  return {
    ...window.navigatorApp,
 ...
 */
export function useAdminApp(): AdminAppAPI {
