...
export function TaskInputBar({
  ...
  return (
    <div className="w-full space-y-2">
      ...
      <div
        className="rounded-xl border border-border bg-card shadow-md transition-all duration-200 ease-navigator cursor-text focus-within:border-primary/40 focus-within:shadow-lg"
